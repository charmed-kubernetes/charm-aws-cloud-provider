...
"""Dispatch logic for the AWS Cloud Provider charm."""
...
from provider_manifests import AWSProviderManifests
...
class AwsCloudProviderCharm(CharmBase):
    ...
    def __init__(self, *args):
        ...
        self.framework.observe(self.on.aws_integration_relation_changed, self._merge_config)
